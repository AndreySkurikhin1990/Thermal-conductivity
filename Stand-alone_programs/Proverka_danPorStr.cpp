...
if (!isrp) { s=0.0; r=0.0;
for (k=0; k<qg; k++) { srra[k]=(p+l)/2e0; //ðàñ÷åò õàðàêòåðèñòèê ïîðèñòîé ñòðóêòóðû ïðè óñëîâèè ïîð â ôîðìå ïðÿìîóãîëüíîãî ïàðàëëåëåïèïåäà
s=s+srra[k]*raspr[k]; r=r+raspr[k]; legr[k]=l; p=p+h; l=l+h; } 
k=0; if (fabs(r)>0.0) s=s/r; else r=0.0; } 
else if (isrp==1) { //ðàñ÷åò õàðàêòåðèñòèê ïîðèñòîé ñòðóêòóðû ïðè óñëîâèè øàðîîáðàçíûõ ïîð
