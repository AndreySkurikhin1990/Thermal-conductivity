%рассеяние только для ППП для шамота
function [ t ] = tmp63()
npp=Kramers_n_Shamot_uk()-1; 
%npp=PokazPrelMas();
na=3.6; ko=27; de=1e-1; ep=de/1e1;
dv=1.4:de:ko;
dvr=na:de:ko;
q=1; np=0;
for k=1:length(dv)
...
n1=n1';
fidTr=fopen('Pryamougolnye_Parallelepipedy_Tr-2.txt','w'); fiddpp=fopen('Pryamougolnye_Parallelepipedy_dpp-2.txt','w'); 
fidTrs=fopen('Pryamougolnye_Parallelepipedy_Trs-2.txt','w'); fiddnra=fopen('Pryamougolnye_Parallelepipedy_dnra-2.txt','w'); 
fidrazdT=fopen('Pryamougolnye_Parallelepipedy_razdT-2.txt','w'); fidn1=fopen('Pryamougolnye_Parallelepipedy_nKBr-2.txt','w'); 
fiddv=fopen('Pryamougolnye_Parallelepipedy_dl_vo-2.txt','w'); 
