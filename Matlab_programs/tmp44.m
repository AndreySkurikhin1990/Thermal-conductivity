...
fidTr=fopen('Cylindry_Tr.txt','w'); fiddpp=fopen('Cylindry_dpp.txt','w'); 
fidTrs=fopen('Cylindry_Trs.txt','w'); fiddnra=fopen('Cylindry_dnra.txt','w'); 
fidrazdT=fopen('Cylindry_razdT.txt','w'); fidn1=fopen('Cylindry_nKBr.txt','w'); 
fiddv=fopen('Cylindry_dl_vo.txt','w'); 
np(q)=npp(length(npp)); 
no=4 %no - номер фракции
