function [ PokPrel ] = Kramers_n_Itom620()
format long g;
...
nnus=PokazPrelomAl(om,oms,alsr,c0); %nnu=PokazPrelomPribl(om,oms,nnus)-1; %nnu=nnu+1+(1.543-1)*0.5+0.5*(1.56-1); %вермикулит и шамот
w1=5e-1; w2=1e0-w1; 
