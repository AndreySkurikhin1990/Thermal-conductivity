function [ alsre ] = IntegrDlVolVer56;
dlvo=dlvoVer5681(); dlvo2=dlvoVer5682(); 
Tal=TrkoVer5681(); Tal2=TrkoVer5682(); 
ndlvo=length(dlvo);  ndlvo2=length(dlvo2); 
mkbr=250.882; mv=0.320; tol=0.76; rokbr=2.75; rov=0.4; 
mkbr2=249.590; mv2=0.533; tol2=0.72; rov2=rov; 
vkbr=mkbr/(1e3*rokbr); vv=mv/(1e3*rov); vkbr2=mkbr2/(1e3*rokbr); vv2=mv2/(1e3*rov2);

dlvo3=dlvoVer5683(); dlvo4=dlvoVer5691(); 
Tal3=TrkoVer5683(); Tal4=TrkoVer5691(); 
ndlvo3=length(dlvo3);  ndlvo4=length(dlvo4); 
mkbr3=249.213; mv3=0.849; tol3=0.69; 
mkbr4=250.299; mv4=0.223; tol4=0.73; rov3=0.4; rov4=rov3; 
vkbr3=mkbr3/(1e3*rokbr); vv3=mv3/(1e3*rov3); vkbr4=mkbr4/(1e3*rokbr); vv4=mv4/(1e3*rov4); t0=273.15;

dlvo5=dlvoVer5692(); dlvo6=dlvoVer5693(); 
Tal5=TrkoVer5692(); Tal6=TrkoVer5693(); 
ndlvo5=length(dlvo5);  ndlvo6=length(dlvo6); 
mkbr5=249.441; mv5=0.502; tol5=0.73; rokbr=2.75; rov5=0.4; 
...
%legend(p,'0.13 %','0.21 %', '0.34 %');  set(gca,'FontName','TimesET'); set(gca,'FontSize',10);
...
%legend(p1,'0.09 %','0.2 %', '0.32 %');  set(gca,'FontName','TimesET'); set(gca,'FontSize',10);
