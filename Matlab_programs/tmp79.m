...
fidTr=fopen('Pryamougolnye_Parallelepipedy_Tr-kao-1.txt','w'); fiddpp=fopen('Pryamougolnye_Parallelepipedy_dpp-kao-1.txt','w'); 
fidTrs=fopen('Pryamougolnye_Parallelepipedy_Trs-kao-1.txt','w'); fiddnra=fopen('Pryamougolnye_Parallelepipedy_dnra-kao-1.txt','w'); 
fidrazdT=fopen('Pryamougolnye_Parallelepipedy_razdT-kao-1.txt','w'); fidn1=fopen('Pryamougolnye_Parallelepipedy_nKBr-kao-1.txt','w'); 
fiddv=fopen('Pryamougolnye_Parallelepipedy_dl_vo-kao-1.txt','w'); 
