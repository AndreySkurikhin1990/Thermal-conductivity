...
fidTr=fopen('Pryamougolnye_Parallelepipedy_Tr-itom-1.txt','w'); fiddpp=fopen('Pryamougolnye_Parallelepipedy_dpp-itom-1.txt','w'); 
fidTrs=fopen('Pryamougolnye_Parallelepipedy_Trs-itom-1.txt','w'); fiddnra=fopen('Pryamougolnye_Parallelepipedy_dnra-itom-1.txt','w'); 
fidrazdT=fopen('Pryamougolnye_Parallelepipedy_razdT-itom-1.txt','w'); fidn1=fopen('Pryamougolnye_Parallelepipedy_nKBr-itom-1.txt','w'); 
fiddv=fopen('Pryamougolnye_Parallelepipedy_dl_vo-itom-1.txt','w'); 
