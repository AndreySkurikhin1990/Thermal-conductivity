...
fidTr=fopen('Shary_Tr-2.txt','w'); fiddpp=fopen('Shary_dpp-2.txt','w'); 
fidTrs=fopen('Shary_Trs-2.txt','w'); fiddnra=fopen('Shary_dnra-2.txt','w'); 
fidrazdT=fopen('Shary_razdT-2.txt','w'); fidn1=fopen('Shary_nKBr-2.txt','w'); 
fiddv=fopen('Shary_dl_vo-2.txt','w'); 
np(q)=npp(length(npp)); 
