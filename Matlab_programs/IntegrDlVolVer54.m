...
legend(p,'0.1 %','0.22 %', '0.32 %');  set(gca,'FontName','TimesET'); set(gca,'FontSize',10);
...
p1=plot(dlvo4,Tal4,'-b',dlvo5,Tal5,'-k',dlvo6,Tal6,'-r');set(p1,'LineWidth',2);  hold on; grid on;
legend(p1,'0.12 %','0.21 %', '0.3 %');  set(gca,'FontName','TimesET'); set(gca,'FontSize',10);
xlabel({'Длина волны, мкм'}); ylabel({'Коэффициент поглощения, мкм-1'}); title({'График зависимости коэффициента поглощения от длины волны'}); figure;
p2=plot(dlvo7,Tal7,'-k',dlvo8,Tal8,'-r',dlvo9,Tal9,'-b');
legend(p2,'0.14 %','0.21 %','0.34 %');  set(gca,'FontName','TimesET'); set(gca,'FontSize',10);
...
%p1=plot(dll4,all4,'-r',dll5,all5,'-g',dll6,all6,'-b'); set(p1,'LineWidth',2); hold on; grid on;
%legend(p1,'0.12 %','0.21 %', '0.3 %');  set(gca,'FontName','TimesET'); set(gca,'FontSize',10);
%xlabel({'Длина волны, мкм'}); ylabel({'Коэффициент поглощения, мкм-1'}); 
%title({'График зависимости коэффициента поглощения от длины волны'}); figure;
%p2=plot(dll7,all7,'-b',dll8,all8,'-c',dll9,all9,'-r');set(p2,'LineWidth',2); hold on; grid on;
%legend(p2,'0.14 %','0.21 %', '0.34 %');  set(gca,'FontName','TimesET'); set(gca,'FontSize',10);
%xlabel({'Длина волны, мкм'}); ylabel({'Коэффициент поглощения, мкм-1'}); 
