...
fidTrs=fopen('Cylindry_Trs-1.txt','w'); fiddnra=fopen('Cylindry_dnra-1.txt','w'); 
fidrazdT=fopen('Cylindry_razdT-1.txt','w'); fidn1=fopen('Cylindry_nKBr-1.txt','w'); 
fiddv=fopen('Cylindry_dl_vo-1.txt','w'); np(q)=npp(length(npp)); 
