function [ PokPrel ] = Kramers_n_Itom860()
format long g;
...
nnu=PokazPrelomPribl(om,oms,nnus)+dob; %nnu=PokazPrelomPribl(om,oms,nnus)+(1.543-1)*0.25+(1-0.25)*(1.56-1); %вермикулит и шамот %n0=postrGraf(nnu,nnus,om,oms);
PokPrel=nnu;
end
