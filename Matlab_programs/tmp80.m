...
fidTr=fopen('Pryamougolnye_Parallelepipedy_Tr-kao-2.txt','w'); 
fiddpp=fopen('Pryamougolnye_Parallelepipedy_dpp-kao-2.txt','w'); 
fidTrs=fopen('Pryamougolnye_Parallelepipedy_Trs-kao-2.txt','w'); 
fiddnra=fopen('Pryamougolnye_Parallelepipedy_dnra-kao-2.txt','w'); 
fidrazdT=fopen('Pryamougolnye_Parallelepipedy_razdT-kao-2.txt','w'); 
fidn1=fopen('Pryamougolnye_Parallelepipedy_nKBr-kao-2.txt','w'); 
fiddv=fopen('Pryamougolnye_Parallelepipedy_dl_vo-kao-2.txt','w'); 
...
while (dvr<=dvko)
    w=PoiskNomera(dlv,dvr); dlvo=dlv(w); chit=1e0; 
    TRs=TrRef(w-1)+(TrRef(w)-TrRef(w-1))*(dvr-dlv(w-1))/(dlv(w)-dlv(w-1)); TRs=exp(-TRs*xve)
...
mkbr=[234.132,234.323]; 
mv=[0.928,1.04];
tol=[0.68, 0.65];
rokbr=2.75; rov=2.6; n=length(mv);
for k=1:n
