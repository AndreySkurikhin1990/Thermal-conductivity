...
function t = Kellet_cas_2() %vyfv,vysv,vmivmf,vyuv
...
vmivmf=0
vyuv=1
Tna=1e2; delT=1e2; Tkon=12e2;
Te=Tna:delT:Tkon+te0;
...
ektp=vydelPol(temvci,temvhi,qoi,ektpvi,temvsi,4);
...
fid = fopen('Kellet_Vermikulit_sluchay_2_TG.txt','w');
p=length(massi);
for k=1:p
    fprintf(fid,'%0.20f\n',massi(k));
end
...
fid = fopen('Kellet_Vermikulit_sluchay_2_TKh.txt','w');
p=length(massi);
for k=1:p
    fprintf(fid,'%0.20f\n',massi(k));
end
...
fid = fopen('Kellet_Vermikulit_sluchay_2_PTP.txt','w');
p=length(massi);
for k=1:p
    fprintf(fid,'%0.20f\n',massi(k));
end
...
fid = fopen('Kellet_Vermikulit_sluchay_2_CHKTP.txt','w');
p=length(massi);
for k=1:p
    fprintf(fid,'%0.20f\n',massi(k));
end
...
fid = fopen('Kellet_Vermikulit_sluchay_2_Alpha.txt','w');
p=length(massi);
for k=1:p
    fprintf(fid,'%0.20f\n',massi(k));
end
...
fid = fopen('Kellet_Vermikulit_sluchay_2_Pokazatel_Pogloscheniya.txt','w');
p=length(massi);
for k=1:p
    fprintf(fid,'%0.20f\n',massi(k));
end
...
fid = fopen('Kellet_Vermikulit_sluchay_2_KO.txt','w');
p=length(massi);
for k=1:p
    fprintf(fid,'%0.20f\n',massi(k));
end
...
fid = fopen('Kellet_Vermikulit_sluchay_2_mm.txt','w');
p=length(massi);
for k=1:p
    fprintf(fid,'%0.20f\n',massi(k));
end
...
fid = fopen('Kellet_Vermikulit_sluchay_2_Am.txt','w');
p=length(massi);
for k=1:p
    fprintf(fid,'%0.20f\n',massi(k));
end
...
fid = fopen('Kellet_Vermikulit_sluchay_2_EKTP.txt','w');
p=length(massi);
for k=1:p
    fprintf(fid,'%0.20f\n',massi(k));
end
