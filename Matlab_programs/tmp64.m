...
fidTr=fopen('Shary_Tr-Sha1.txt','w'); fiddpp=fopen('Shary_dpp-Sha1.txt','w'); 
fidTrs=fopen('Shary_Trs-Sha1.txt','w'); fiddnra=fopen('Shary_dnra-Sha1.txt','w'); 
fidrazdT=fopen('Shary_razdT-Sha1.txt','w'); fidn1=fopen('Shary_nKBr-Sha1.txt','w'); 
fiddv=fopen('Shary_dl_vo-Sha1.txt','w'); 
np(q)=npp(length(npp)); 
