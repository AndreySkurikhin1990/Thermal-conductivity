...
fidTr=fopen('Shary_Tr-3.txt','w'); fiddpp=fopen('Shary_dpp-3.txt','w'); 
fidTrs=fopen('Shary_Trs-3.txt','w'); fiddnra=fopen('Shary_dnra-3.txt','w'); 
fidrazdT=fopen('Shary_razdT-3.txt','w'); fidn1=fopen('Shary_nKBr-3.txt','w'); 
fiddv=fopen('Shary_dl_vo-3.txt','w'); 
np(q)=npp(length(npp)); 
