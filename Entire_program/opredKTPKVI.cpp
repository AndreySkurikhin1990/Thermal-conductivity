...
const int N = 13, vmik = 0, vybkvi = 6, nnxtk = 0, nxtk = 30; //vmik: 0 - êåðàìîâåðìèêóëèò, 1 - ÈÒÎÌ, vybkvi: 4 - 400, 5 - 500, 6 - 600, 7 - 700, 8 - 800, 9 - 900, 10 - 1000
const char nfk = 'C';
struct derevo {
...
{ 	int k, q = 100, j, r, f;
	...
	return p; }
double **izmRTAkvi(double *tere, int kost, int izm, double *Ra, double *Ta, double *Aa, double *Rb, double *Tb, double *Ab, int v) //izm = 0 - íåò èçìåíåíèé, izm - ó÷èòûâàþòñÿ èçìåíåíèÿ //ïîèñê èçìåíåíèÿ ñòåïåíè ÷åðíîòû èëè áåçðàçìåðíîãî êîýôôèöèåíòà ïîãëîùåíèÿ
...
void opredtemphckvi(double *efktpv, double *eftev, double *tgv, double *thv, double *qon, int dlma, int n, double h) //n=3 - äëèíà ìàññèâà êîýôôèöèåíòîâ ïðèáëèæàþùåãî ìíîãî÷ëåíà, tgv - òåìïåðàòóðà ãîðÿ÷åé ñòåíêè, thv - òåìïåðàòóðà õîëîäíîé ñòåíêè, dlma - äëèíà ìàññèâà ÝÊÒÏ
